...
- Open MFT file in e.g. MFTexplorer (used in this case) or MFTECmd to export to csv
...
This is file 0x2B as record number is represented in hex
...
This is file with actual size 0x** as file sizes are represented in hex                                                     
...
```
for i in {000..500}; do
r=$(echo $i | nc 94.237.49.138 43069 -q 5)
letter=$(echo $r | cut -d ":" -f 3)
...
- Everything could be more elegantly handled by a script but this was expedient
