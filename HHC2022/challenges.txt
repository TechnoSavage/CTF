...
#### Lock 4: (use enter key rather than 'go' button i.e. bypass onblur input sanitization)/

    <svg width="200" height="200"><rect x="0" y="0" width="100%" height="100%" fill="white" /><rect x="0" y="100" width="100%" height="100%" fill="blue" /></svg>

#### Lock 5: (use enter key rather than 'go' button i.e. bypass onblur input sanitization)
